...
np.save('cifar10/results/l2_norm/no_redundant_thresh_spars.npy',perCsp*100)
np.save('cifar10/results/l2_norm/no_redundant_thresh_l2_avg.npy',l2_avg)
np.save('cifar10/results/l2_norm/no_redundant_thresh_l2_var.npy',l2_var)
