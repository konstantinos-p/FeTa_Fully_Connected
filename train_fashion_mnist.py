# Simple model for Fashion Mnist
import numpy
...
#This code trains a fully connected DNN to classify the Fashion Mnist dataset. For the output dimensions of the fully connected layers
# we have a default setting of:
# Dense1.out = 1000
# Dense2.out = 500
# Dense3.out = #classes
# which gets an accuracy of 90%.
...
print("Accuracy: %.2f%%" % (scores[1]*100))#90%

model.save('fashion_mnist/fashion_mnist_model.h5')
