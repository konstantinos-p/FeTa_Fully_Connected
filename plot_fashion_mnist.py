...
feta_acc = np.load('fashion_mnist/results/accuracy/no_redundant_feta_acc.npy')
feta_sp = np.load('fashion_mnist/results/accuracy/no_redundant_feta_spars.npy')
thr_acc = np.load('fashion_mnist/results/accuracy/no_redundant_thresh_acc.npy')
thr_sp = np.load('fashion_mnist/results/accuracy/no_redundant_thresh_spars.npy')
