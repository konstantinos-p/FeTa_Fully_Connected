...
Xtr1 = np.load('fashion_mnist/training/flatten_output_tn.npy')
Ytr1 = np.load('fashion_mnist/training/dense_1_output_tn.npy')
Xtr2 = np.load('fashion_mnist/training/dense_1_output_tn.npy')
Ytr2 = np.load('fashion_mnist/training/dense_2_output_tn.npy')

Xval1 = np.load('fashion_mnist/training/flatten_output_val.npy')
Yval1 = np.load('fashion_mnist/training/dense_1_output_val.npy')
Xval2 = np.load('fashion_mnist/training/dense_1_output_val.npy')
Yval2 = np.load('fashion_mnist/training/dense_2_output_val.npy')

latent_X_original = np.load('fashion_mnist/testing/dense_2_output_ts.npy')

#Sparsity thresholding values

#perCsp1 = np.array([0.0000012,0.00004,0.00001,0.00001,0.00001,0.00001,0.00001,0.00001,0.00001,0.00001])
#perCsp2 = np.array([0.000007,0.0003,0.00001,0.00001,0.00001,0.00001,0.00001,0.00001,0.00001,0.00001])

perCsp1 = np.linspace(0.0000012,0.00004,iteration_steps)
perCsp2 = np.linspace(0.000007,0.0003,iteration_steps)
...
np.save('fashion_mnist/results/l2_norm/no_redundant_feta_spars.npy',perCsp*100)
np.save('fashion_mnist/results/l2_norm/no_redundant_feta_l2_avg.npy',l2_avg)
np.save('fashion_mnist/results/l2_norm/no_redundant_feta_l2_var.npy',l2_var)
