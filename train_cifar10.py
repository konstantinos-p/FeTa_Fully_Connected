...
#This code trains a fully connected DNN to classify the Cifar10 dataset. For the output dimensions of the fully connected layers
# we have a default setting of:
# Dense1.out = 1000
# Dense2.out = 500
# Dense3.out = #classes
# which gets an accuracy of 50%.
...
print("Accuracy: %.2f%%" % (scores[1]*100))#50%

model.save('cifar10/cifar10_model.h5')
